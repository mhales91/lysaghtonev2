-- Create sample data for the Lysaght One application
...
(gen_random_uuid(), 'Acme Corporation', 'contact@acme.com', '+61 2 1234 5678', '123 Business St, Sydney NSW 2000', NOW(), NOW()),
(gen_random_uuid(), 'TechStart Pty Ltd', 'info@techstart.com.au', '+61 3 9876 5432', '456 Innovation Ave, Melbourne VIC 3000', NOW(), NOW()),
(gen_random_uuid(), 'Global Solutions Inc', 'hello@globalsolutions.com', '+61 7 5555 1234', '789 Enterprise Blvd, Brisbane QLD 4000', NOW(), NOW()),
(gen_random_uuid(), 'Local Business Co', 'admin@localbusiness.com.au', '+61 8 1111 2222', '321 Main St, Perth WA 6000', NOW(), NOW())
